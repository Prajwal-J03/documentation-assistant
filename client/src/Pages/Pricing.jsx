...
const Pricing = () => {
    return (
        <div className='container mx-auto mb-20'>
            ...
            <div>
                <h1 className='text-xl font-bold mb-8'>Not the plan your looking for?</h1>
                <div className='w-full border rounded-2xl flex flex-col items-center justify-between py-16 mb-8'>
                    <h4 className='text-lg font-bold mb-8'>Contact Support Team</h4>
                    <p className='w-120 mb-2'><span className='text-xl text-red-600'>* </span>Name: </p>
                    <input type="text" name="name" id="name" className='border border-gray-400 h-12 w-120 rounded-lg px-4 mb-4' required />
                    <p className='w-120 mb-2'><span className='text-xl text-red-600'>* </span>Email: </p>
                    <input type="email" name="email" id="email" className='border border-gray-400 h-12 w-120 rounded-lg px-4 mb-4' required />
                    <p className='w-120 mb-2'><span className='text-xl text-red-600'>* </span>Detailed Query: </p>
                    <textarea name="query" id="query" rows='8' cols='59' className='border border-gray-400 rounded-lg px-4 py-2 mb-4'></textarea>
                    <p className='w-118 mt-8'>Or else you can contact us from below email id or mobile number:</p>
                    <p className='w-118 mt-4'>Email id: <b>contactus@ailegatrix</b></p>
                    <p className='w-118 mt-4'>Contact number: <b>+91 1234567890</b></p>
                </div>
            </div>
        </div>
    )
